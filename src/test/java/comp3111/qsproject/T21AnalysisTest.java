...
class T21AnalysisTest {
    ...
    void calculateRegular() {
        ...
        double expectedScore = (778.0 + 765.0 + 72.0) / 3.0;
    ...
    void getLineChartData() {
        ...
        double NorthEastern2017 = 324.0;
        double NorthEastern2020 = 317.0;
        double Aston2017 = 327.0;
    ...
    void getLineInvalidYear2() {
        ...
        double NTU2017 = 914.0;
        double NTU2018 = 922.0;
        double NE2017 = 324.0;
        double NE2018 = 339.0;
